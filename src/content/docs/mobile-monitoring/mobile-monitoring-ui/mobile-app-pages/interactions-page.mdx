...
1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile >**</DoNotTranslate> (select an app) <DoNotTranslate>**> More views > Interactions**</DoNotTranslate>.
...
To show the full list of all instrumented methods: From the selected interaction, select the <DoNotTranslate>**Breakdown table**</DoNotTranslate> link. If you use custom instrumentation for any of the metrics, the category for the class and method name will indicate <DoNotTranslate>**custom**</DoNotTranslate>. 
...
1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select an app) > App > Interactions**</DoNotTranslate>.
2. From the <DoNotTranslate>**Slowest traces**</DoNotTranslate> table, select the <DoNotTranslate>**Activity**</DoNotTranslate> or <DoNotTranslate>**Duration**</DoNotTranslate> link for the trace.
...
* To help provide context for the data, click <DoNotTranslate>**Previous interaction**</DoNotTranslate>.
